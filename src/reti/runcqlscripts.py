...
parser = argparse.ArgumentParser(description="Run a folder containing cql scripts.")
...
parser.add_argument(
    ...
    nargs="?",
    type=str,
    const="/Users/elliottmacneil/python/reti/src/FCE",
)
parser.add_argument(
    "--db_dir",
    action="store",
    nargs="?",
    type=str,
    const="/Users/elliottmacneil/chess/pgn/hammratty2022.pgn",
)
parser.add_argument(
    "--output_dir",
    action="store",
    nargs="?",
    type=str,
    const="/Users/elliottmacneil/python/reti/output",
)
parser.add_argument(
    "--cql_bin_dir",
    action="store",
    nargs="?",
    type=str,
    const="/Users/elliottmacneil/chess/cql6/cql",
)
